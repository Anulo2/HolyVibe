...
import type {
  AuthorizedPerson,
  CreateAuthorizedPersonData,
  UpdateAuthorizedPersonData,
...
interface AggiungiModificaPersonaDialogProps {
  ...
  onAddPerson: (data: CreateAuthorizedPersonData) => void;
  onUpdatePerson: (data: UpdateAuthorizedPersonData) => void;

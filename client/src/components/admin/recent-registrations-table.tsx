					...
					{recentRegistrations.map((registration) => (
						...
						>
							<div className="flex items-center gap-3">
								<Avatar>
									<AvatarImage
										src={registration.bambino.avatar}
										alt={registration.bambino.nome}
									/>
									<AvatarFallback>
										{registration.bambino.nome.charAt(0)}
									</AvatarFallback>
								</Avatar>
								<div>
							...
							<div className="flex items-center gap-4">
								<div className="text-sm">
									<span className="text-muted-foreground">Genitore:</span>{" "}
									{registration.genitore.nome}
								</div>
								<Badge
									variant={
								...
								>
									{registration.stato.charAt(0).toUpperCase() +
										registration.stato.slice(1)}
								</Badge>

...
import { Building2, Edit, Eye, Filter, Plus, Trash2 } from "lucide-react";
import { useState } from "react";
import { AdminCreaEventoDialog } from "@/components/admin/admin-crea-evento-dialog";
import { AssignOrganizationDialog } from "@/components/admin/assign-organization-dialog";
...
function AdminEventiPage() {
	...
	const handleAssignOrganization = (evento: any) => {
		setSelectedEvent(evento);
		setShowAssignDialog(true);
	};

	const _handleManageRegistrations = (evento: any) => {
											...
											<TableCell className="text-right">
												<div className="flex justify-end gap-1">
													...
													<Button
														variant="ghost"
														size="sm"
														onClick={() => handleAssignOrganization(evento)}
														title="Assegna organizzazione"
													>

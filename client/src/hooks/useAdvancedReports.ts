...
export type ReportType = "events_stats" | "user_analytics" | "financial_report" | "age_distribution";
...
export const useUserAnalyticsReport = (startDate?: string, endDate?: string) => {
...
export const useAgeDistributionReport = (startDate?: string, endDate?: string) => {

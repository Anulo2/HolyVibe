            ...
            !event.organization?.photoVideoMinorsDeclaration && (
              <div className="bg-purple-50 dark:bg-purple-950/20 p-6 rounded-lg border border-purple-200 dark:border-purple-800">
                ...
                <div className="text-sm text-muted-foreground bg-background p-4 rounded">
                  <p className="mb-2">
                    Durante questo evento verranno scattate foto e/o video che
                    potrebbero includere i partecipanti minorenni.
                  </p>
                  <p className="mb-2">
                    Durante la registrazione, i genitori potranno autorizzare o
                    negare il consenso per il trattamento delle immagini del
                    proprio figlio/figlia secondo le finalità specificate
                    dall'organizzazione.
                  </p>
